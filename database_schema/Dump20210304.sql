...
CREATE TABLE `application` (
  ...
  `submitted` varchar(5) DEFAULT NULL,
...
CREATE TABLE `review` (
  ...
  `date_of_review` varchar(45) DEFAULT NULL,
  KEY `fk_review_admin1_idx` (`admin_id`),
  KEY `fk_review_application1_idx` (`application_number`),
  CONSTRAINT `fk_review_admin1` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`admin_id`),
  CONSTRAINT `fk_review_application1` FOREIGN KEY (`application_number`) REFERENCES `application` (`application_number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-03-04 13:56:18
