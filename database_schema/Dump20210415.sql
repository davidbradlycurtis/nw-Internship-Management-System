...
CREATE TABLE `agreements` (
  ...
  `organization_address` varchar(75) DEFAULT NULL,
...
CREATE TABLE `internship_applications` (
  ...
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
  `street_line_1` varchar(75) DEFAULT NULL,
  `street_line_2` varchar(75) DEFAULT NULL,
  ...
  `student_id` int NOT NULL,
  `approved_by` int DEFAULT NULL,
  `student_line_1` varchar(75) DEFAULT NULL,
  `student_line_2` varchar(75) DEFAULT NULL,
...
-- Dump completed on 2021-04-15 14:03:30
